...
Este es un problema de **aprendizaje supervisado** de tipo **regresión**:

- **Entrada:** $x_i = (\text{usuario\_id}, \text{película\_id}, \text{atributos demográficos}, \text{géneros})$
- **Salida:** $y_i \in \{1, 2, 3, 4, 5\}$ (discreta pero continua en esencia)
- **Objetivo:** Minimizar el error de predicción de ratings no observados

### Relevancia práctica

Este problema es representativo de los **sistemas de recomendación** modernos utilizados en plataformas como Netflix, Amazon Prime y Spotify, donde:

* Existen miles de usuarios e ítems
* Solo una pequeña fracción de interacciones es observada
* Es necesario **inferir preferencias faltantes** para generar recomendaciones personalizadas
